...
<div id="hero" class="h-full">
    <div
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60"
            style="background-image: url('assets/images/bg/travel&hospitality.jpg');"></div>
        ...
        <div class="relative max-w-7xl px-6 pb-12 text-left z-10 md:bottom-48 md:left-24">
            <h1 class="text-3xl md:text-6xl text-white leading-tight animate-blink mb-4 hero-h1">
                Take a digital leap into your Travel & Hospitality Operation
            </h1>
...
<div id="next-section" class="container mx-auto my-16 md:my-32 px-4 md:px-0 flex flex-col md:flex-row items-center">
    <div class="w-full md:w-1/2 ">
        ...
        Despite its vibrancy and excitement, the travel and hospitality sector faces particular difficulties that may have an influence on operational effectiveness and consumer satisfaction. Software solutions can be of great aid with anything from handling intricate reservations and inventory to guaranteeing flawless visitor experiences. Vasp Technologies uses state-of-the-art technology to create creative tools that tackle these problems head-on. The difficulty of handling reservations and inventories is one of the main problems facing the sector. Innovative solutions with features like dynamic pricing tools, real-time inventory management systems, and user-friendly booking platforms can make these procedures more efficient.
        </p>
        <a href="travel&hospitality-details.php"
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img src="assets/images/img/travel1.jpg" alt="Business professionals looking out the window"
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0">
    <div class="pb-2 md:pb-8 md:px-0">
        <div class="flex flex-wrap items-center justify-between py-4">
            <div class="w-full">
                <h2 class="text-blue-950 text-3xl md:text-4xl font-semibold py-2 mb-2">Our Focus Areas</h2>
                <p class="text-gray-700 text-lg text-left">Redefining travel and hospitality operations. </p>
            </div>
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div
            ...
            <img src="assets/images/img/travel2.jpg" class="w-full h-full object-cover">
            <div
            ...
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Hotels & Resorts</h3>
            </div>
            <div
                ...
                <p class="text-white px-4 pt-4">A travel and hospitality management system simplifies operations by centralising reservations, streamlining housekeeping, and ensuring seamless guest experiences.</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/travel.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Tours & Travels</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4">An ERP for travel and hospitality facilitates client management, itinerary automation, and financial insights.</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/travel3.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Bookings and Reservations</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4 pt-4">A centralised booking platform integrated with various payment gateways and automated confirmation and reminder system helps in smooth booking and reservation.
</p>
            </div>
        </div>
    </div>
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0 hidden md:block">
    ...
    <div class="flex flex-row space-x-4">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer expanded"
            style="background-image: url('assets/images/img/travel4.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-100 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Reservation Management</h2>
                <p class="text-white">Streamline the booking process, manage availability, and handle cancellations efficiently.</p>
            </div>
            <div
                ...
                <h2 class="text-2xl font-semibold text-white text-left">Reservation Management</h2>
            </div>
        </div>
        <!-- Accordion Item 2 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/travel5.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                ...
                <p class="text-white">Track room availability, equipment, and resources to optimise utilisation and avoid overbooking.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <!-- Accordion Item 3 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/travel6.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Financial Management</h2>
                <p class="text-white">Handle accounting, payments, and reporting to ensure financial health and compliance.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <!-- Accordion Item 4 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/travel7.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Customer Relationship Management (CRM)</h2>
                <p class="text-white">Build strong relationships with guests, manage loyalty programs, and provide personalised experiences.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <!-- Accordion Item 5 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/travel8.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Property Management</h2>
                <p class="text-white">Oversee maintenance, housekeeping, and facilities management to maintain property standards.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
...
<div class="container mx-auto my-16 md:my-32">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/travel9.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
        ...
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/travel10.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
        ...
        <div class="bg-gray-100 md:bg-white  shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/travel11.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
                <a href="blog-details.php" class="text-xl font-semibold text-blue-950 hover:text-blue-900">Case Study
