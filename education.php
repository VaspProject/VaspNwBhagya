...
<div id="hero" class="h-full">
    <div
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60"
            style="background-image: url('assets/images/bg/edu.jpg');"></div>
        ...
        <div class="relative max-w-7xl px-6 pb-12 text-left z-10 md:bottom-48 md:left-24">
            <h1 class="text-3xl md:text-6xl text-white leading-tight animate-blink mb-4 hero-h1">
                Take a digital leap into your educational management
            </h1>
        </div>
...
<div id="next-section" class="container mx-auto my-16 md:my-32 px-4 md:px-0 flex flex-col md:flex-row items-center">
    <div class="w-full md:w-1/2 ">
        ...
        <p class="text-md md:text-lg text-gray-700 mb-4">
            Technological development has taken a strong grip in every sphere of life, and the educational sector is one
            of them, of course. As the pandemic struck the world in 2020, remote learning and teaching became the new
            normal. Since then, the educational system has been experiencing a total shift towards digitalisation.

            In a world where AI has started to permeate our work atmosphere to enhance productivity as well as ease
            human involvement to an extent, it’s imperative for educational institutions to embrace the progress in
            information and technology in terms of their management.

            Accordingly, realising this objective initiates a solid educational IT solution partnership. Here comes Vasp
            Technologies’ robust educational software solution to mitigate overall academic service efficiency and
            student outcomes without striking a balance.


        </p>
        <a href="education-details.php"
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img src="assets/images/img/kids-writing.jpg"
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0 hidden md:block">
    ...
    <div class="flex flex-row space-x-4">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer expanded"
            style="background-image: url('assets/images/img/teaching.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-100 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Admission Process</h2>
                <p class="text-white">It automates various tasks, such as application forms, document verification, and fee payment, ensuring a smooth and efficient admission experience.</p>
            </div>
            <div
                ...
                <h2 class="text-2xl font-semibold text-white text-left">Admission Process</h2>
            </div>
        </div>
        <!-- Accordion Item 2 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('https://images.unsplash.com/photo-1522661067900-ab829854a57f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Fees Collection</h2>
                <p class="text-white">The system also automates fee reminders and tracking, reducing administrative burden and ensuring timely payments.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Fees Collection</h2>
            </div>
        </div>
        <!-- Accordion Item 3 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('https://images.unsplash.com/photo-1588072432836-e10032774350?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Student Management</h2>
                <p class="text-white">It helps track student progress, generate reports, and facilitate communication between teachers, parents, and students. This feature is essential for effective student monitoring and support.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <!-- Accordion Item 4 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('https://images.pexels.com/photos/159844/cellular-education-classroom-159844.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Account Management</h2>
                <p class="text-white">It helps schools maintain accurate financial records, ensure compliance with regulations, and make informed decisions based on financial data.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <!-- Accordion Item 5 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Data Managements</h2>
                <p class="text-white">It ensures data accuracy, consistency, and security, enabling efficient retrieval and analysis. This feature is crucial for informed decision-making, reporting, and compliance with educational regulations.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Data Managements</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            ...
            <div class="py-6 md:p-8">
                ...
                <p class="text-md md:text-lg text-gray-700 mt-2">One of the well-known multilingual, coeducational, CBSE schools in Narengi, Guwahati,
        ...
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            ...
            <div class="py-6 md:p-8">
                <a href="blog-details.php" class="text-xl font-semibold text-blue-950 hover:text-blue-900">Case Study
                    2</a>
                <p class="mt-2 text-md md:text-lg text-gray-700">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius quae natus
