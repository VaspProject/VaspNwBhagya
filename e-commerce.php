...
<div id="hero" class="h-full">
    <div class="relative h-screen w-full bg-blue-950 flex flex-col items-center justify-center md:justify-end md:items-start overflow-hidden transition duration-300 ease-in-out">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60" style="background-image: url('assets/images/bg/e-commerce.jpg');"></div>
        ...
        <div class="relative max-w-7xl px-6 pb-12 text-left z-10 md:bottom-48 md:left-24">
            ...
            Take a digital leap into your E-Commerce handling
            </h1>
        </div>
...
<div id="next-section" class="container mx-auto my-16 md:my-32 px-4 md:px-0 flex flex-col md:flex-row items-center">
    <div class="w-full md:w-1/2 ">
        ...
        The e-commerce industry has experienced exponential growth in recent years, driven by technological advancements and changing consumer behaviour. As online shopping becomes increasingly prevalent, software companies play a crucial role in providing the tools and platforms that power e-commerce businesses.

From online marketplaces and payment gateways to inventory management systems and customer relationship management (CRM) software, software solutions are essential for e-commerce success.

One of the most crucial areas where digital innovation is making a significant impact is in the realm of customer experience. E-commerce businesses demand delivering exceptional customer service to remain competitive. Vasp Technologies’ custom software solutions can help achieve this by providing tools for personalised recommendations, efficient order fulfilment, and seamless returns processing.
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img src="assets/images/img/e-commerce.jpg" alt="Business professionals looking out the window" class="shadow-lg w-full md:w-11/12 object-cover">
    </div>
</div>
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0">
    <div class="pb-2 md:pb-8 md:px-0">
        <div class="flex flex-wrap items-center justify-between py-4">
            <div class="w-full">
                ...
                <p class="text-gray-700 text-lg text-left">Redefining e-commerce operation.</p>
            </div>
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/product-sales.jpg" class="w-full h-full object-cover">
            ...
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Analytics And Reporting</h3>
            </div>
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4 pt-4">With key tracking performance indicators, as an e-commerce service provider you can  analyse customer behaviour, and make data-driven decisions.</p>
            </div>
        </div>

        <div class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/carrying-box.jpg" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out"></div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Order Fulfilment And Shipping</h3>
            </div>
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4 pt-4">With order processing, inventory management, packaging, shipping arrangements, and order tracking, we ensure timely and accurate order fulfilment.</p>
            </div>
        </div>

        <div class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/customer-service.jpg" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out"></div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Customer Service And Support</h3>
            </div>
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4">It involves providing timely and effective assistance to customers through various channels, such as email, live chat, and phone support. </p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0 hidden md:block">
    ...
    <div class="flex flex-row space-x-4">
        <!-- Accordion Item 1 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer expanded" style="background-image: url('assets/images/img/e-commerce1.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-100 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Inventory Management</h2>
                <p class="text-white">Providing a comprehensive overview of product stock levels, it ensures that products are always available to meet customer demand. This feature is crucial for maintaining product availability and minimising stockouts.
</p>
            </div>
            <div class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-semibold text-white text-left">Inventory Management</h2>
            </div>
        </div>
        <!-- Accordion Item 2 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed" style="background-image: url('assets/images/img/e-commerce2.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Order & Return Management</h2>
                <p class="text-white">This feature automates order processing, and provides real-time tracking of shipments. Also, it handles returns efficiently, providing customers with easy return options and managing the return process effectively.</p>
            </div>
            <div class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Order & Return Management</h2>
            </div>
        </div>
        <!-- Accordion Item 3 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed" style="background-image: url('assets/images/img/e-commerce3.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Warehouse Management</h2>
                <p class="text-white">By optimising warehousing operations, it provides visibility into inventory locations, storage assignments, and picking and packing processes. Thus, resulting in reducing labour costs, minimising errors, and improving overall warehouse efficiency.</p>
            </div>
            <div class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed" style="background-image: url('https://img.freepik.com/free-photo/box-market-electronic-ordering-shop-basket_1421-567.jpg?t=st=1723547508~exp=1723551108~hmac=2cf15947900992992b407eccfe8fb3481305f74e6c09f80b179bf93a3037111f&w=996');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Customer Management</h2>
                <p class="text-white">Providing a centralised platform for managing customer information, interactions, and preferences, it enables businesses to track customer orders, manage returns, and provide personalised customer service. </p>
            </div>
            <div class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed" style="background-image: url('https://img.freepik.com/free-photo/e-commerce-shop-online-homepage-sale-concept_53876-120965.jpg?t=st=1723547675~exp=1723551275~hmac=37aea07c92f852c4e0053f4be32d5a91aac739580065b19869ee6cbd110cc4c9&w=826');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Accounting</h2>
                <p class="text-white">By integrating with accounting software to provide real-time financial data and insights, this feature helps businesses maintain accurate financial records, identify trends, and make informed business decisions.
</p>
            </div>
            <div class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Accounting</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="container mx-auto my-16 md:my-32">
    <div class="pb-2 md:pb-8 px-4 md:px-0">
        <div class="flex flex-wrap items-center justify-between py-4">
            <div class="w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/e-commerce6.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
        ...
        <div class="bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/e-commerce7.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
        ...
        <div class="bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/e-commerce8.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
