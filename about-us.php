...
<div id="hero" class="h-full">
    <div
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60"
            style="background-image: url('assets/images/bg/about.jpg');"></div>
        ...
        <div class="relative max-w-7xl px-6 pb-12 text-left z-10 md:bottom-48 md:left-24">
            <h1 class="text-3xl md:text-6xl text-white leading-tight animate-blink mb-4 hero-h1">
                We Craft Softwares That Empowers Your Business Goals
            </h1>
        </div>
...
<div id="next-section" class="container mx-auto my-16 md:my-22 flex flex-col md:flex-row items-center">
    <div class="md:full px-4">
        ...
        <p class="text-md md:text-lg text-gray-700 leading-normal">To lead the way in technology innovation, driving sustainable growth and
    ...
    <div class="md:full px-4 mt-6 md:mt-0">
        ...
        <p class="text-md md:text-lg text-gray-700 leading-normal">To deliver innovative services and reliable IT solutions that drive
...
<div class="container mx-auto my-16 md:my-22 flex flex-col md:flex-row items-center">
    ...
    <div class="md:w-1/2 px-4 md:pl-8">
        ...
        <p class="text-md md:text-lg text-gray-700 text-justify">Our decade-long journey stands as a testament to our legacy of excellence. At Vasp Technologies, our synergistic approach fosters deep-rooted relationships and ensures client satisfaction. Together, we drive client success with a commitment to industry-leading products and skilled development teams that propel your business forward.</p>
        <p class="text-md md:text-lg text-gray-700 text-justify mt-2">For over ten years, we have been a premier Software as a Service (SaaS) provider in Guwahati and across India. Since 2012, we’ve distinguished ourselves with a comprehensive suite of software development solutions.
        </p>
        <p class="text-md md:text-lg text-gray-700 text-justify mt-2">From web and mobile app development to custom software creation and enterprise-level solutions, Vasp Technologies serves a diverse range of industries, including education, healthcare, e-commerce, finance, and banking. Our expertise allows us to deliver tailored solutions that address the unique needs of each client.</p>
    </div>
</div>
    ...
    <div class="swiper-container overflow-hidden my-10 mx-12 md:mx-16">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Successfully rolled out our first product<br> Desalite Connect,
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Realising the nuisances involved<br>in the viable operations
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Upgraded Desalite Connect one step<br> ahead agin its earlier
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Vasp958 was launched in 2017 for<br>effective operation of
                    defence<br> personnel’s leave management,<br>pay slip distribution, maintaining<br> employee information etc.
                </p>
            </div>
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Upgraded Desalite Connect one step<br>ahead (V.3.0) agin its
            ...
            <div class="swiper-slide flex flex-col items-center relative text-center cursor-grab">
                ...
                <p class="mt-6 pl-6 text-gray-600 text-left">Dedicating to transforming cold <br>storage management, we
                    created<br>Icebox to ensure the efficient<br>preservation and management of<br> your valuable goods.</p>
            </div>
