...
<div id="next-section" class="container mx-auto my-16 md:my-32 px-4 md:px-0 flex flex-col md:flex-row items-center">
    <div class="w-full md:w-1/2 ">
        ...
        <p class="text-lg text-gray-700 mb-4">
            The public sector encompasses government agencies, healthcare institutions, educational establishments, and
            many more. As these organisations strive to improve efficiency, transparency, and service delivery, they are
            turning to software companies for tailored solutions.

            From citizen engagement platforms and electronic governance systems to healthcare informatics and
            educational technology, software is playing a vital role in modernising public sector operations.

            One of the most significant trends in the public sector is the increasing adoption of e-governance
            initiatives. These initiatives aim to streamline government processes, reduce corruption, and improve
            citizen access to services.
            Software solutions, such as citizen portals and online service platforms, are essential for implementing
            e-governance. By digitising government services, these platforms can enhance transparency, efficiency, and
            accessibility.

        </p>
        <a href="public-sector-details.php"
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img src="assets/images/img/public-sector10.jpg" alt="Business professionals looking out the window"
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0">
    <div class="pb-2 md:pb-8 md:px-0">
        <div class="flex flex-wrap items-center justify-between py-4">
            <div class="w-full">
                ...
                <p class="text-gray-700 text-lg text-left">Redefining public sector operation</p>
            </div>
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div
            ...
            <img src="assets/images/img/public-sector3.jpg" class="w-full h-full object-cover">
            <div
            ...
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Policy Handling</h3>
            </div>
            <div
                ...
                <p class="text-white px-4 pt-4">Centralising policy repositories, automating dissemination, and tracking
                    compliance make crucial public sector operations like policy handling effortless.</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/public-sector6.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Data Protection</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4 pt-4">Incorporating encryption mechanisms, and audit trails to safeguard sensitive
                    information we help public sector departments in enhancing data protection.</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/public-sector4.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Resource Optimisation</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4">By tracking resources and identifying constraints, we empower organisations
                    to make data-driven decisions and optimise resources.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0 hidden md:block">
    ...
    <div class="flex flex-row space-x-4">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer expanded"
            style="background-image: url('assets/images/img/public-sector2.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-100 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Real-Time Data Accessibility</h2>
                <p class="text-white">By providing access to real-time data, public sector organisations can respond
                    quickly to changing circumstances and optimise resource allocation.</p>
            </div>
            <div
                ...
                <h2 class="text-2xl font-semibold text-white text-left">Real-Time Data Accessibility</h2>
            </div>
        </div>
        <!-- Accordion Item 5 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/public-sector8.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Unified Information System</h2>
                <p class="text-white">A unified system streamlines workflows and reduces redundancies, eliminating data silos and improving collaboration.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Unified Information System</h2>
            </div>
        </div>
        <!-- Accordion Item 2 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/public-sector9.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Cybersecurity Measures</h2>
                <p class="text-white">Robust cybersecurity measures are essential to maintain public trust and prevent
                    data loss to handle sensitive information such as financial reports and personal data.
                </p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Cybersecurity Measures</h2>
            </div>
        </div>
        <!-- Accordion Item 3 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/public-sector7.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Asset Management</h2>
                <p class="text-white">This feature provides a comprehensive overview of an organisation's physical
                    assets, including infrastructure, equipment, and property.
        ...
        <!-- Accordion Item 4 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/public-sector.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Customer Relationship Management (CRM)</h2>
                <p class="text-white">CRM in the public sector is a powerful tool for managing interactions with
                    citizens and stakeholders. It enables personalised and efficient service delivery between citizens
                    and government agencies.
                </p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Customer Relationship Management (CRM)</h2>
            </div>
        </div>
...
<div class="container mx-auto my-16 md:my-32">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/public-sector5.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
        ...
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/public-sector12.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
        ...
        <div class="bg-gray-100 md:bg-white  shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/public-sector11.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
                <a href="blog-details.php" class="text-xl font-semibold text-blue-950 hover:text-blue-900">Case Study
