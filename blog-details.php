        ...
        <div class="md:w-2/3 bg-white shadow-lg rounded-lg overflow-hidden mb-8 md:mb-0 md:mr-4">
            ...
            <div class="p-6 md:p-12">
                ...
                <div class="text-md text-gray-700 leading-relaxed space-y-4">
                    <p>In today's competitive business landscape, a strong supply chain is no longer a luxury, it's a necessity. An efficient flow of goods from raw materials to customer doorstep is critical for business success.</p>

                    <h5 class="text-xl font-semibold">What is Supply Chain?</h5>
                    <p>A supply chain is the network of people, companies, resources, and activities involved in getting a product or service from its very beginning (raw materials) to the final customer. Consider it as a lengthy chain with numerous links, each of which stands for a different stage of the procedure. Businesses cannot operate well or deliver goods to customers without an effective supply chain.</p>
                    <p>But what exactly makes a supply chain strong?</p>
                    <p>This blog post dives into the 5 cornerstones that underpin a reliable and adaptable supply chain process, giving you the tools to ensure your business can weather any storm and deliver exceptional customer service.</p>

                    <h5 class="text-xl font-semibold">The 5 pillars of a strong supply chain are:</h5>
