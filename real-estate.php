...
<div id="hero" class="h-full">
    <div
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60"
            style="background-image: url('assets/images/bg/real-estate.jpg');"></div>
        ...
        <div class="relative max-w-7xl px-6 pb-12 text-left z-10 md:bottom-48 md:left-24">
            ...
            Take a digital leap into your Real Estate operation.
            </h1>
        </div>
...
<div id="next-section" class="container mx-auto my-16 md:my-32 px-4 md:px-0 flex flex-col md:flex-row items-center">
    <div class="w-full md:w-1/2 ">
        ...
        The real estate industry forms the cornerstone of today's global economy. And it has been undergoing a digital transformation powered by innovative technological solutions. From property management and brokerage to construction and development the process of digitalisation has revolutionised the way real estate operates. 

By leveraging cutting-edge technologies like artificial intelligence, blockchain, and virtual reality, Vasp Technologies as the leading tech company commits to offer tailored solutions that address the unique challenges and opportunities faced by the real estate sector.

One of the most significant trends in the real estate industry is the increasing adoption of property management software. These platforms streamline administrative tasks, improve tenant communication, and optimise property performance.

        </p>
        <a href="real-estate-details.php"
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img src="assets/images/img/real-estate.jpg"
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0">
    <div class="pb-2 md:pb-8 md:px-0">
        <div class="flex flex-wrap items-center justify-between py-4">
            <div class="w-full">
                ...
                <p class="text-gray-700 text-lg text-left">Redefining real estate operation.</p>
            </div>
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div
            ...
            <img src="assets/images/img/real-estate1.jpg" class="w-full h-full object-cover">
            <div
            ...
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Effective Collaboration</h3>
            </div>
            <div
                ...
                <p class="text-white px-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam odit sunt
                    totam nostrum unde nobis. Alias quas molestias ex nesciunt.</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/real-estate2.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">More Projects In Minimal Time</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4">A powerful real estate ERP facilitates time savings and increases project productivity fueled by a smooth work mechanism .</p>
            </div>
        </div>

        <div
            class="relative group h-60 w-auto transform transition-transform duration-300 ease-in-out hover:translate-y-[-5px]">
            <img src="assets/images/img/real-estate3.jpg" class="w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-black opacity-50 group-hover:opacity-60 transition-opacity duration-300 ease-in-out">
            </div>
            <div class="absolute inset-0 flex items-start justify-start p-4">
                <h3 class="text-white text-2xl font-semibold pt-6">Effective marketing techniques using CRM 
</h3>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                <p class="text-white px-4 pt-4">With the application of efficient sales and marketing techniques supported by a strong real estate ERP system, real estate companies can establish a devoted clientele.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mx-auto my-16 md:my-36 px-4 md:px-0 hidden md:block">
    ...
    <div class="flex flex-row space-x-4">
        ...
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer expanded"
            style="background-image: url('assets/images/img/real-estate4.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-100 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Document Management
</h2>
                <p class="text-white">Leverage sophisticated document management applications to steer clear of all the document management annoyances, such as misplaced documents, and security concerns. </p>
            </div>
            <div
                ...
                <h2 class="text-2xl font-semibold text-white text-left">Document Management</h2>
            </div>
        </div>
        <!-- Accordion Item 2 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/real-estate5.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Property Listing Management</h2>
                <p class="text-white">Take advantage of cloud-based technology to construct extensive property management systems that offer realistic leasing and property data.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Property Listing Management</h2>
            </div>
        </div>
        <!-- Accordion Item 3 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/real-estate6.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Lease & Contract Management</h2>
                <p class="text-white">Gain valuable insights into lease performance, tenant behaviour, and revenue generation, enabling data-driven decision-making and optimising rental strategies.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">Lease & Contract Management</h2>
            </div>
        </div>
        <!-- Accordion Item 4 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/real-estate7.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">User Portal</h2>
                <p class="text-white">The user portal module delivers efficient communication and data management  enhancing resident satisfaction, rent collection, and maintenance.</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
                <h2 class="text-2xl font-bold text-white">User Portal</h2>
            </div>
        </div>
        <!-- Accordion Item 5 -->
        <div class="accordion-item flex-1 bg-cover bg-center relative h-96 transition-all duration-300 cursor-pointer collapsed"
            style="background-image: url('assets/images/img/real-estate8.jpg');">
            <div class="absolute inset-0 overlay"></div>
            <div class="absolute bottom-0 left-0 right-0 p-6 opacity-0 transition-opacity duration-300">
                <h2 class="text-2xl font-bold mb-4 text-white">Sales Management</h2>
                <p class="text-white">It simplifies real estate sales, reduces costs, boost response rates, increases conversions, and enhances client satisfaction.
</p>
            </div>
            <div
                class="absolute inset-0 flex items-center justify-left pt-8 transform origin-center hover-hide transition-opacity duration-300 vertical-text">
...
<div class="container mx-auto my-16 md:my-32">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/real-estate9.jpg" alt="blog"
        ...
        <div class="bg-gray-100 md:bg-white shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/real-estate10.jpg" alt="blog" class="w-full h-64 mt-6 md:mt-0">
                </div>
            </div>
            <div class="py-6 md:p-8">
        ...
        <div class="bg-gray-100 md:bg-white  shadow-lg hover:bg-blue-100 px-4 md:px-0">
            <div class="relative overflow-hidden">
                <div class="transition-transform duration-700 ease-in-out transform-gpu hover:scale-125">
                    <img src="assets/images/img/real-estate11.jpg"
