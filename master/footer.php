...
<div class="container mx-auto my-2 md:my-2 px-4">
    <div class="flex flex-col md:flex-row justify-between items-center py-4">
        <!-- Copyright -->
        <div class="text-gray-600 text-center md:text-left">
            &copy; <?php echo date('Y'); ?> <a href="#">Vasp Technologies Pvt. Ltd.</a> All rights reserved.
        </div>
