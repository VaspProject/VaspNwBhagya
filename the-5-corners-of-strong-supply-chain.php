    ...
    <div class="md:flex justify-between items-start space-x-8">
        <div class="w-full md:w-2/3 bg-white  rounded-lg overflow-hidden mb-8 md:mb-0 md:mr-4">
            <div class="relative p-4 md:p-12 ">
                <img src="assets/images/blogs/b3.jpg" alt="blog" class="w-full h-48 md:h-96 object-cover rounded-lg">
            ...
            <div class="p-4 md:p-12">
                ...
                <div class="text-md text-gray-700 leading-relaxed space-y-4 ">
                    ...
                    <div class="text-md md:text-lg space-y-4">
                        ...
                        <h5 class="text-xl font-semibold text-blue-950 pt-2">In conclusion:</h5>
            ...
            <div class="bg-white  md:sticky  rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex">
                        ...
                        <div class="w-2/4"><a href="#" class="block text-xl text-blue-600 hover:text-blue-800 ">The 5 Cornerstones of a Strong Supply Chain</a>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        <div class="w-1/4 pr-4"><img src="assets/images/blogs/b3.jpg" alt="blog"
                                class="rounded-lg w-full object-cover "></div>
                        <div class="w-2/4"><a href="#" class="block text-xl text-blue-600 hover:text-blue-800 ">5
                                Sustainable
                    ...
                    <div class="flex">
                        <div class="w-1/4 pr-4"><img src="assets/images/blogs/b1.png" alt="blog"
                                class="rounded-lg w-full object-cover"></div>
                        <div class="w-2/4"><a href="#" class="block text-xl text-blue-600 hover:text-blue-800 ">The Rise of AI and Machine Learning in IT</a>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        <div class="w-1/4 pr-4"><img src="assets/images/blogs/b5.png" alt="blog"
                                class="rounded-lg w-full object-cover"></div>
                        <div class="w-2/4"><a href="#" class="block text-xl text-blue-600 hover:text-blue-800 ">The Future of the IoT (Internet of Things)</a>
                        </div>
                    </div>
                    <!-- <div>
