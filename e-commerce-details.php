...
<div id="hero" class="h-full">
    <div
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-blue-950 opacity-60"
            style="background-image: url('https://c1.wallpaperflare.com/path/572/808/14/shopping-business-retail-shopping-cart-ec46c507455d91d2e8508e37fe9240be.jpg');">
        </div>
...
<div id="next-section" class="container mx-auto my-16 md:my-32 flex flex-col md:flex-row items-center">
    <div class="md:full px-4 md:px-0">
        <h2 class="text-blue-950 text-3xl md:text-4xl font-semibold py-2 mb-2">Take a digital leap into your e-commerce
            handling</h2>
        <p class="text-md md:text-lg italic pb-2"></p>
        <p class="text-md md:text-lg">The e-commerce industry has experienced exponential growth in recent years, driven
            by technological advancements and changing consumer behaviour. As online shopping becomes increasingly
            prevalent, software companies play a crucial role in providing the tools and platforms that power e-commerce
            businesses.
        </p><br>
        <p class="text-md md:text-lg">From online marketplaces and payment gateways to inventory management systems and customer relationship management (CRM) software, software solutions are essential for e-commerce success</p>
        <br>
        <p class="text-md md:text-lg">One of the most crucial areas where digital innovation is making a significant impact is in the realm of customer experience. E-commerce businesses demand delivering exceptional customer service to remain competitive.</p>
        <br>
        <p class="text-md md:text-lg">Vasp Technologies’ custom software solutions can help achieve this by providing tools for personalised recommendations, efficient order fulfilment, and seamless returns processing. Additionally, CRM software enables businesses to track customer interactions, analyse purchasing behaviour, and build lasting relationships.</p>
        <br>
        <p class="text-md md:text-lg">Another key area where application of software solutions becomes essential is in optimising e-commerce operations. Inventory management systems help businesses track stock levels, manage warehouse operations, and prevent stockouts.</p>
        <br>
        <p class="text-md md:text-lg">Along with this payment gateways ensure secure and efficient transactions, while fraud prevention applications safeguards businesses from financial losses. By leveraging these software solutions, e-commerce businesses can improve their operational efficiency, reduce costs, and increase profitability.</p>
        <br>
...
<!-- <div class="container mx-auto my-16 md:my-32">
    <div class="pb-2 md:px-0">
        <div class="flex flex-wrap items-left justify-between py-4">
            <div class="w-full">
                <h2 class="text-blue-950 text-3xl md:text-5xl font-bold text-left mb-12">We contribute to creating a conducive educational ecosystem.</h2>
            </div>
        </div>
    </div>
    <div class="flex flex-wrap md:flex-nowrap items-center justify-between">
        <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
            ...
            <h6 class="text-xl font-semibold">Teachers </h6>
            <p class="text-md md:text-lg text-gray-700 leading-relaxed">
                Teachers can use this advanced tool to better schedule and instruct students, acquire important operational data, interact and communicate with one another, and submit reports to the academic management.
            </p>
        </div>
        <div class="w-full md:w-1/2 px-4">
            <div class="flex justify-center items-center ">
                <img src="assets/images/img/info.png" alt="Infographic" class="object-contain h-full w-[500px]">
            </div>
        </div>
    </div>
    <div class="flex flex-wrap md:flex-nowrap items-center justify-between mt-12 md:mt-0">
        <div class="w-full md:w-1/2 px-4 hidden md:block">
            <div class="flex justify-center items-center ">
                <img src="assets/images/img/info.png" alt="Infographic" class="object-contain h-full w-[500px]">
            </div>
        </div>
        <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
            ...
            <h6 class="text-xl font-semibold">Parents/Students </h6>
            <p class="text-md md:text-lg text-gray-700 leading-relaxed">
                Parents can use this advanced tool to gain any information about their child such as fee dues, holidays, time tables, exam schedules, academic performance, PTM etc.
                Students can use it to proactively check their assignments, due dates, and academic events, and track academic progress.
            </p>
        </div>
