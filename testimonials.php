...
<div id="content">
<div class="md:my-22 bg-gradient-to-r from-[#4c8ea9] to-[#60124f] " id="educational">
        <div class="py-8 md:py-16">
            <div class="flex flex-col md:flex-row space-x-4 md:space-x-8 space-y-12 md:space-y-0">
                <div class="relative">
                    <img src="assets/images/clientele/6.png" alt="Phone with cityscape"
                        class="w-full md:w-[1050px] h-full md:h-full" loading="eager">
                    <h2
                        class="text-white text-[100px] md:text-[253px] font-bold transform rotate-90 absolute left-[-138px] md:left-[-420px] top-[25%] md:top-[30%]  md:tracking-[20px]">
                        CLIENTS
                    </h2>
                </div>
                <div class="text-white space-y-4 md:space-y-8 pr-4 md:pr-16 ">
                    <button
                        class="flex items-center bg-white text-gray-950 rounded-full py-2 px-4 shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                        <img src="assets/images/clientele/7.png" alt="Icon" class="w-6 h-6 mr-2" loading="eager">
                        <span class="text-gray-950 text-lg md:text-xl font-bold whitespace-nowrap">Educational
                            Industry</span>
                    </button>
                    <ul class="md:space-y-2 space-y-1 text-md md:text-xl font-semibold">
                        <li>St. Andrew School, Nagaland</li>
                        <li>Little Angel English HS, Sonapur</li>
                        <li>St. Rose School</li>
                        <li>Heritage Public School, Gotanagar</li>
                        <li>Heritage Public School, Bharalumukh</li>
                        <li>St. Francis De Sales, Dhemaji</li>
                        <li>St. Francis De Sales, Guwahati</li>
                        <li>Christ King School, Gogamukh</li>
                        <li>St. Francis De Sales, Silapathar</li>
                        <li>St. Francis De Sales, Telam</li>
                        <li>St. Joseph, Seppa</li>
                        <li>The Reality Public School</li>
                        <li>St. Xavier High School, Mushalpur</li>
                        <li>St. Francis De Sales, Pasighat</li>
                        <li>St. Francis De Sales, Bahalpur</li>
                        <li>St. Mary's High School, North Lakhimpur</li>
                        <li>Fransalian High School, Jonai</li>
                        <li>Don Bosco High School, Silapathar</li>
                        <li>North East English Public School</li>
                        <li>Sunflower High School, Shantipur</li>
                        <li>My Three Jey High School, Jonai</li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <div class="md:my-22 bg-gradient-to-r from-[#4c8ea9] to-[#60124f] " id="engineering">
        <div class="py-8 md:py-16">
            <div class="flex flex-col md:flex-row space-x-4 md:space-x-8 space-y-12 md:space-y-0">
                <div class="relative">
                    <img src="assets/images/clientele/8.png" alt="Phone with cityscape"
                        class="w-full md:w-[1050px] h-full md:h-full" loading="eager">
                    <h1
                        class="text-white text-[100px] md:text-[253px] font-bold transform rotate-90 absolute left-[-138px] md:left-[-420px] top-[25%] md:top-[30%]  md:tracking-[20px]">
                        CLIENTS
                ...
                <div class="text-white space-y-4 md:space-y-8 pr-4 md:pr-16">
                    <button
                        class="flex items-center bg-white text-gray-950 rounded-full py-2 px-4 shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                        <img src="assets/images/clientele/7.png" alt="Icon" class="w-6 h-6 mr-2" loading="eager">
                        <span class="text-gray-950 text-lg md:text-xl font-bold whitespace-nowrap">Engineering
                            Industry</span>
                    </button>
                    <ul class="md:space-y-2 space-y-1 text-md md:text-xl font-semibold">
                        <li>Bearing & Bearings</li>
                        <li>Hindustan Engineering</li>
                        <li>Ankan The Design Desk</li>
                        <li>Brahmaputra Corrugator</li>
                        <!-- <li>Vijoy Scales & Co (Electronics)</li> -->
                        <li>NASA - New Age System & Appliances</li>
                        <li>Albarin</li>
                        <li>Xtech TM Steel TMT Rebar</li>
                        <li>Green AAC Block</li>
                        <li>Goswami Engineering</li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <div class="md:my-22 bg-gradient-to-r from-[#4c8ea9] to-[#60124f] " id="commercial">
        <div class="py-8 md:py-16">
            <div class="flex flex-col md:flex-row space-x-4 md:space-x-8 space-y-12 md:space-y-0">
                <div class="relative">
                    <img src="assets/images/clientele/9.png" alt="Phone with cityscape"
                        class="w-full md:w-[1050px] h-full md:h-full" loading="eager">
                    <h2
                        class="text-white text-[100px] md:text-[253px] font-bold transform rotate-90 absolute left-[-138px] md:left-[-420px] top-[25%] md:top-[30%]  md:tracking-[20px]">
                        CLIENTS
                ...
                <div class="text-white space-y-4 md:space-y-8 pr-4 md:pr-16">
                    <button
                        class="w-full flex items-center bg-white text-gray-950 rounded-full py-2 px-4 shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                        <img src="assets/images/clientele/7.png" alt="Icon" class="w-6 h-6 mr-2" loading="eager">
                        <span class="text-gray-950 text-lg md:text-xl font-bold whitespace-nowrap">Commercial
                            Services
                            Industry</span>
                    </button>
                    <ul class="md:space-y-2 space-y-1 text-md md:text-xl font-semibold">
                        <li>Percept Infracon</li>
                        <li>Sam Communications</li>
                        <li>Beach Vacation</li>
                        <li>INest Group</li>
                        <li>Rhino Roadways Corporatio</li>
                        <li>Deha Tea Estate</li>
                        <li>Exhotic Holidays & Events</li>
                        <li>Domagk Pharma</li>
                        <li>Popular Packers & Movers</li>
                        <li>Majuli Tourism</li>
                        <li>Aryan Events Solution</li>
                        <li>Trident Infraprojects</li>
                        <li>Travel Zone</li>
                        <li>Shree Builders</li>
                        <li>Elite</li>
                        <li>Prem Cargo Service</li>
                        <li>Siddhi Vinayak Logistics</li>
                        <li>ASIDC</li>
                        <li>MSFS Dibrughar Province</li>
                        <li>TOAA</li>
                        <li>Exotic Events & Conferences</li>
                        <li>Centre for Tourism Studies</li>
                        <li>RJB Realtors</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="mx-auto md:my-22">
        <div class="flex flex-col md:flex-row ">
                ...
                <div class="py-12 px-4 md:px-16 text-white space-y-8 md:space-y-16">
                    ...
                    <div class="space-y-6 md:space-y-12 md:pr-24">
                        <div class="flex flex-row space-x-2">
                            <div class="w-1/6 md:w-1/12 flex">
                                <img src="assets/images/clientele/11.png" alt="Blog 7"
                        ...
                        <div class="flex flex-row space-x-2">
                            <div class="w-1/6 md:w-1/12 flex">
                                <img src="assets/images/clientele/12.png" alt="Blog 7"
                                    class="h-12 w-12 md:h-16 md:w-16 mx-auto md:mx-0" loading="eager">
                            </div>
                            <div class="w-5/6 md:w-11/12">
                                <h2 class="font-bold text-left text-xl md:text-2xl font-light">
                        ...
                        <div class="flex flex-row space-x-2">
                            <div class="w-1/6 md:w-1/12 flex">
                                <img src="assets/images/clientele/13.png" alt="Blog 7"
                                    class="h-12 w-12 md:h-16 md:w-16 mx-auto md:mx-0" loading="eager">
                            </div>
                            <div class="w-5/6 md:w-11/12">
                                <h2 class="font-bold text-left text-xl md:text-2xl font-light">
            ...
            <div class="w-full md:w-1/4 relative flex flex-col ">
                <img src="assets/images/clientele/10.png" alt="" class="hidden md:block w-full h-auto flex-grow"
                    loading="eager">
                <img src="assets/images/clientele/14.png" alt="" class="block md:hidden w-full h-auto flex-grow"
                    loading="eager">

                <a href="contact"
                    class="hidden md:block top-16 absolute left-1/2 transform -translate-x-1/2 w-3/5 flex justify-center items-center transition duration-300 ease-in-out transform hover:scale-105">
                    <button class="mt-4 text-xl text-center bg-white text-[#000000] py-2 px-12 rounded-full ">
                        Contact Us

                    </button>
                </a>
                <a href="contact"
                    class="block md:hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/5 flex justify-center items-center ">
                    <button class="text-xl text-center bg-white text-[#000000] py-2 px-12 rounded-full">
                        Contact Us
                    </button>
                </a>
            </div>
